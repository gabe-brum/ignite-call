...
const claimUsernameFormSchema = z.object({
  username: z
    ...
    .regex(/^([a-z\\-]+)$/i, { message: 'Usuário pode ter apenas letras e hifens.' })
...
export function ClaimUsernameForm() {
  ...
  async function handleUsernameSubmit(data: ClaimUsernameFormData) {
    const { username } = data
  ...
  return (
    <>
    <Form as="form" onSubmit={handleSubmit(handleUsernameSubmit)}>
      <TextInput
        size="sm"
        prefix="ignite.com/"
